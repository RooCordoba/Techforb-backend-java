...
public class DB_User_model{
    ...
    @Schema(description = "Nombre del usuario", required = true, defaultValue = "nombre")
    ...
    @Schema(description = "Apellido del usuario", required = true, defaultValue = "apellido")
    ...
    @Schema(description = "Password del usuario", required = true, defaultValue = "password")
    @NotBlank(message = "El password no tiene que ser vacío")
    private String password;

    @Column(unique = true)
    @Schema(description = "DNI del usuario", required = true, defaultValue = "1234")
    @Positive(message= "El dni tiene que ser un numero positivo")
    @Pattern(regexp = "^[0-9]+$", message = "El DNI debe contener solo números")
    private String dni;

    @Schema(description = "Numero de celular del usuario", defaultValue = "123456789")
